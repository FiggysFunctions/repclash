...
const SIDED_ALWAYS = ['dumbbell-row', 'meadows-row', 'bulgarian-split-squat', 'concentration-curl'];
const SIDED_OPTION = [
...
const EXERCISES = [
  ...
  ['romanian-deadlift','Romanian Deadlift','Strength','strength',1.05,'🏋️','Legs','Barbell'],
  ...
  ['barbell-row','Barbell Row','Strength','strength',1.00,'🏋️','Back','Barbell'],
  ['barbell-curl','Barbell Curl','Strength','strength',0.34,'🏋️','Arms','Barbell'],
  ['hip-thrust','Barbell Hip Thrust','Strength','strength',0.47,'🏋️','Glutes','Barbell'],
  ['smith-squat','Smith Machine Squat','Strength','strength',1.00,'🏋️','Legs','Smith machine'],
  ['smith-bench','Smith Machine Bench Press','Strength','strength',0.87,'🏋️','Chest','Smith machine'],
  ['smith-row','Smith Machine Row','Strength','strength',0.78,'🏋️','Back','Smith machine'],
  ['dumbbell-press','Dumbbell Bench Press','Strength','strength',0.87,'💪','Chest','Dumbbell'],
  ['incline-dumbbell-press','Incline Dumbbell Press','Strength','strength',0.80,'💪','Chest','Dumbbell'],
  ['dumbbell-row','Dumbbell Row','Strength','strength',0.78,'💪','Back','Dumbbell'],
  ['meadows-row','Meadows Row','Strength','strength',0.78,'🏋️','Back','Barbell'],
  ['lateral-raise','Lateral Raise','Strength','strength',0.29,'💪','Shoulders','Dumbbell'],
  ['bicep-curl','Dumbbell Curl','Strength','strength',0.34,'💪','Arms','Dumbbell'],
  ['hammer-curl','Hammer Curl','Strength','strength',0.34,'💪','Arms','Dumbbell'],
  ['bulgarian-split-squat','Bulgarian Split Squat','Strength','strength',0.87,'💪','Legs','Dumbbell'],
  ['goblet-squat','Goblet Squat','Strength','strength',0.74,'💪','Legs','Dumbbell'],
  ['hack-squat','Hack Squat','Strength','strength',0.34,'🎚️','Legs','Machine'],
  ['leg-press','Leg Press','Strength','strength',0.28,'🎚️','Legs','Machine'],
  ['leg-extension','Leg Extension','Strength','strength',0.22,'🎚️','Legs','Machine'],
  ['leg-curl','Lying Leg Curl','Strength','strength',0.20,'🎚️','Legs','Machine'],
  ['hip-abduction','Hip Abduction Machine','Strength','strength',0.11,'🎚️','Glutes','Machine'],
  ['hip-adduction','Hip Adduction Machine','Strength','strength',0.11,'🎚️','Legs','Machine'],
  ['chest-press-machine','Chest Press Machine','Strength','strength',0.47,'🎚️','Chest','Machine'],
  ['pec-deck','Pec Deck (Chest Fly)','Strength','strength',0.25,'🎚️','Chest','Machine'],
  ['lat-pulldown','Lat Pulldown','Strength','strength',0.47,'🎚️','Back','Machine'],
  ['seated-row','Seated Cable Row','Strength','strength',0.47,'🎚️','Back','Machine'],
  ['standing-calf-raise','Standing Calf Raise','Strength','strength',0.13,'🎚️','Legs','Machine'],
  ['cable-fly-crossover','Cable Fly Crossover','Strength','strength',0.26,'🔗','Chest','Cable'],
  ['tricep-pushdown','Tricep Pushdown','Strength','strength',0.28,'🔗','Arms','Cable'],
  ['cable-curl','Cable Curl','Strength','strength',0.31,'🔗','Arms','Cable'],
  ['face-pull','Face Pull','Strength','strength',0.23,'🔗','Shoulders','Cable'],
  ['cable-lateral-raise','Cable Lateral Raise','Strength','strength',0.26,'🔗','Shoulders','Cable'],
  ['kettlebell-swing','Kettlebell Swing','Strength','strength',0.47,'🪨','Full body','Kettlebell'],
  ['farmers-carry',"Farmer's Carry",'Strength','timed',5.00,'🪨','Full body','Dumbbell'],
  ['push-up','Push-up','Bodyweight','bodyweight',0.47,'🤸','Chest','Bodyweight'],
  ['pull-up','Pull-up','Bodyweight','bodyweight',2.00,'🤸','Back','Bodyweight'],
  ['dip','Dip','Bodyweight','bodyweight',1.40,'🤸','Chest','Bodyweight'],
  ['burpee','Burpee','Bodyweight','bodyweight',1.60,'🤸','Full body','Bodyweight'],
  ['air-squat','Bodyweight Squat','Bodyweight','bodyweight',0.26,'🤸','Legs','Bodyweight'],
  ['lunge','Lunge','Bodyweight','bodyweight',0.36,'🤸','Legs','Bodyweight'],
  ['assisted-pull-up','Assisted Pull-up','Bodyweight','bodyweight',1.20,'🎚️','Back','Machine'],
  ['sit-up','Sit-up','Core','bodyweight',0.26,'🧘','Core','Bodyweight'],
  ['russian-twist','Russian Twist','Core','bodyweight',0.16,'🧘','Core','Bodyweight'],
  ['weighted-russian-twist','Weighted Russian Twist','Core','strength',0.23,'🧘','Core','Dumbbell'],
  ['cable-crunch','Cable Crunch','Core','strength',0.26,'🔗','Core','Cable'],
  ['plank','Plank','Core','timed',12.00,'🧘','Core','Bodyweight'],
  ['leg-raise','Hanging Leg Raise','Core','bodyweight',0.47,'🧘','Core','Bodyweight'],
...
function effort(ex, v) {
  ...
  // Load curve and rep taper, matching supabase/11_scoring_curve.sql
  const effReps = (n) => (n <= 15 ? n : 15 + (n - 15) * 0.5);

  const total = sets.reduce((sum, s) => {
    const r = effReps(Number(s.reps) || 0), w = Number(s.kg) || 0;
    return sum + (ex.kind === 'strength' ? ppu * r * Math.min(1 + w / 45, 4) : ppu * r);
  }, 0);
