...
const EXERCISES = [
  ...
  ['barbell-curl','Barbell Curl','Strength','strength',0.40,'🏋️','Arms','Barbell'],
  ['hip-thrust','Barbell Hip Thrust','Strength','strength',0.55,'🏋️','Glutes','Barbell'],
  ['smith-squat','Smith Machine Squat','Strength','strength',1.00,'🏋️','Legs','Smith machine'],
  ['smith-bench','Smith Machine Bench Press','Strength','strength',0.95,'🏋️','Chest','Smith machine'],
  ['smith-row','Smith Machine Row','Strength','strength',0.85,'🏋️','Back','Smith machine'],
  ['dumbbell-press','Dumbbell Bench Press','Strength','strength',0.95,'💪','Chest','Dumbbell'],
  ['incline-dumbbell-press','Incline Dumbbell Press','Strength','strength',0.90,'💪','Chest','Dumbbell'],
  ['dumbbell-row','Dumbbell Row','Strength','strength',0.85,'💪','Back','Dumbbell'],
  ['meadows-row','Meadows Row','Strength','strength',0.85,'🏋️','Back','Barbell'],
  ['lateral-raise','Lateral Raise','Strength','strength',0.33,'💪','Shoulders','Dumbbell'],
  ['bicep-curl','Dumbbell Curl','Strength','strength',0.40,'💪','Arms','Dumbbell'],
  ['hammer-curl','Hammer Curl','Strength','strength',0.40,'💪','Arms','Dumbbell'],
  ['bulgarian-split-squat','Bulgarian Split Squat','Strength','strength',0.95,'💪','Legs','Dumbbell'],
  ['goblet-squat','Goblet Squat','Strength','strength',0.80,'💪','Legs','Dumbbell'],
  ['hack-squat','Hack Squat','Strength','strength',0.40,'🎚️','Legs','Machine'],
  ['leg-press','Leg Press','Strength','strength',0.32,'🎚️','Legs','Machine'],
  ['leg-extension','Leg Extension','Strength','strength',0.25,'🎚️','Legs','Machine'],
  ['leg-curl','Lying Leg Curl','Strength','strength',0.28,'🎚️','Legs','Machine'],
  ['hip-abduction','Hip Abduction Machine','Strength','strength',0.14,'🎚️','Glutes','Machine'],
  ['hip-adduction','Hip Adduction Machine','Strength','strength',0.14,'🎚️','Legs','Machine'],
  ['chest-press-machine','Chest Press Machine','Strength','strength',0.55,'🎚️','Chest','Machine'],
  ['pec-deck','Pec Deck (Chest Fly)','Strength','strength',0.28,'🎚️','Chest','Machine'],
  ['lat-pulldown','Lat Pulldown','Strength','strength',0.55,'🎚️','Back','Machine'],
  ['seated-row','Seated Cable Row','Strength','strength',0.55,'🎚️','Back','Machine'],
  ['standing-calf-raise','Standing Calf Raise','Strength','strength',0.16,'🎚️','Legs','Machine'],
  ['cable-fly-crossover','Cable Fly Crossover','Strength','strength',0.30,'🔗','Chest','Cable'],
  ['tricep-pushdown','Tricep Pushdown','Strength','strength',0.32,'🔗','Arms','Cable'],
  ['cable-curl','Cable Curl','Strength','strength',0.35,'🔗','Arms','Cable'],
  ['face-pull','Face Pull','Strength','strength',0.26,'🔗','Shoulders','Cable'],
  ['cable-lateral-raise','Cable Lateral Raise','Strength','strength',0.30,'🔗','Shoulders','Cable'],
  ['kettlebell-swing','Kettlebell Swing','Strength','strength',0.55,'🪨','Full body','Kettlebell'],
  ['farmers-carry',"Farmer's Carry",'Strength','timed',5.00,'🪨','Full body','Dumbbell'],
  ['push-up','Push-up','Bodyweight','bodyweight',0.55,'🤸','Chest','Bodyweight'],
  ...
  ['air-squat','Bodyweight Squat','Bodyweight','bodyweight',0.30,'🤸','Legs','Bodyweight'],
  ['lunge','Lunge','Bodyweight','bodyweight',0.42,'🤸','Legs','Bodyweight'],
  ['assisted-pull-up','Assisted Pull-up','Bodyweight','bodyweight',1.20,'🎚️','Back','Machine'],
  ['sit-up','Sit-up','Core','bodyweight',0.30,'🧘','Core','Bodyweight'],
  ['russian-twist','Russian Twist','Core','bodyweight',0.20,'🧘','Core','Bodyweight'],
  ['weighted-russian-twist','Weighted Russian Twist','Core','strength',0.26,'🧘','Core','Dumbbell'],
  ['cable-crunch','Cable Crunch','Core','strength',0.30,'🔗','Core','Cable'],
  ['plank','Plank','Core','timed',12.00,'🧘','Core','Bodyweight'],
  ['leg-raise','Hanging Leg Raise','Core','bodyweight',0.55,'🧘','Core','Bodyweight'],
